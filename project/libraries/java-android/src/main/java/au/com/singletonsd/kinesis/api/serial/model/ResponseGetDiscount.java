...
public class ResponseGetDiscount implements Serializable {
  ...
  private List<Discounts> items = null;


  public ResponseGetDiscount metadata(Metadata metadata) {
  ...
  **/
  ...
  public ResponseGetDiscount items(List<Discounts> items) {
    
    this.items = items;
    return this;
  }

  public ResponseGetDiscount addItemsItem(Discounts itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Discounts>();
    }
  ...
  **/
  ...
  public List<Discounts> getItems() {
    return items;
  }


  public void setItems(List<Discounts> items) {
    this.items = items;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResponseGetDiscount responseGetDiscount = (ResponseGetDiscount) o;
    return Objects.equals(this.metadata, responseGetDiscount.metadata) &&
        Objects.equals(this.items, responseGetDiscount.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseGetDiscount {\n");
