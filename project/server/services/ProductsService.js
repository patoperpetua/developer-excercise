...
* returns Products
* */
const addProduct = ({ products }) => new Promise(
...
* returns List
* */
const addProducts = ({ requestBulkProduct }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        requestBulkProduct,
...
* returns Products
* */
const editProduct = ({ id, products }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        id,
...
* returns Products
* */
const getProductById = ({ id, deleted }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        id,
...
* */
const getProducts = ({ page, size, sort, deleted, metadata }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        page,
